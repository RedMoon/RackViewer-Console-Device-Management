...
parser = argparse.ArgumentParser(description='replacement of aviation classes')
parser.add_argument(
    '--day',
    type=int,
    default=now.day + 1,
...
print("Поиск расписания на: " + str(args.day) + " " + str(monthToNum(args.month)))
...
for n, i in tqdm(enumerate(items, start=1)):
    ...
    pbar.update(1)
pbar.close()
if(isConsists == False): print("Расписания еще нет!")      
